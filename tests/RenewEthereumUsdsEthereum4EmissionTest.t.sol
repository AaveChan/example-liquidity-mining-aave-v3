...
contract RenewEthereumUsdsEthereum4EmissionTest is LMBaseTest {
  ...
  uint256 constant TOTAL_DISTRIBUTION = 119_953 ether; // 119_953 aUSDS
  uint88 constant NEW_DURATION_DISTRIBUTION = 1 weeks; // 1 week

  address WHALE_1 = 0x3c66133A7fD29ab1E551db9E8832DCA0cEAd7a16; // 1.21% of the supply
  ...
  function test_extend() public {
    ...
    _testClaimRewardsForWhale(WHALE_1, ASSET, 0.0121 ether); // 1.21%
  }
