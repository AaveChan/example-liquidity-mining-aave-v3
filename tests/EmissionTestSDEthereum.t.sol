...
contract EmissionTestSDEthereum is BaseTest {
  ...
  address constant REWARD_ASSET = 0x30D20208d987713f46DFD34EF128Bb16C404D10f;
  IEACAggregatorProxy constant REWARD_ORACLE =
    IEACAggregatorProxy(0x92F786E1Cb028FF9D12c7597fBD8ecc266E9e8fb);
  ...
  uint256 constant TOTAL_DISTRIBUTION = 25_000 ether; // 10'000 MATICX/month, 6 months
  uint88 constant NEW_DURATION_DISTRIBUTION_END = 30 days;
  ...
  function test_extend() public {
    ...
    //vm.stopPrank();
    _testClaimRewardsForWhale(aETHX_WHALE, AaveV3EthereumAssets.ETHx_A_TOKEN, leftover + TOTAL_DISTRIBUTION);
  }
